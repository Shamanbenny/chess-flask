...
def chess_v1(fen: str):
    ...
    for move in legal_moves:
        board.push(move)
        moves_evaluated += 1
        eval = -v1_minimax(3, board.turn, board)
        board.pop()
        if eval > best_eval:
            best_eval = eval
            best_move = move
...
def main():
    ...
    print("1: Minimax (depth 3)")
    print("2: Minimax with alpha-beta pruning (depth 3)")
    print("3: Minimax with alpha-beta pruning and move ordering (depth 3)")
    ...
    if version == "1":
        ...
        result = chess_v1_1(fen)
    elif version == "3":
        result = chess_v1_2(fen)
    else:
...
Select version:
1: Minimax (depth 3)
2: Minimax with alpha-beta pruning (depth 3)
3: Minimax with alpha-beta pruning and move ordering (depth 3)

Enter version: 1
Enter FEN string: r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1
Best move: Nc6
Processing time: 83.3339376449585 seconds
Moves evaluated: 4185552

Enter version: 2
Enter FEN string: r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1
Best move: Bxa6
Processing time: 23.987261533737183 seconds
Moves evaluated: 645128

Enter version: 3
Enter FEN string: r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 1
Best move: Bxa6
Processing time: 20.415566205978394 seconds
Moves evaluated: 179206
"""